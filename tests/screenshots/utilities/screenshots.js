...
const posts = require('../../fixtures/post.cjs')
...
module.exports = {
  generateBaselineScreenshots: async function(baselineDir, browser) {
    ...
    for (let i = 0; i < prefixes.length; i++) {
      ...
      await interceptNetworkRequests(page, JSON.stringify(posts), 'https://content.example.com/wp-json/wp/v2/posts?per_page=1')
  ...
  takeAndCompareScreenshot: async function(baselineDir, currentDir, page, route, filePrefix) {
    ...
    console.log('baselineDir', baselineDir, 'currentDir', currentDir, 'fileName', fileName)
